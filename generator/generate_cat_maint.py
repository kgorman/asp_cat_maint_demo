...
def save_logs_to_mongodb(num_logs=10):
    ...
    logs = [generate_machine_log() for _ in range(num_logs)]
    collection.insert_many(logs)
    print(f"✅ {num_logs} machine logs saved to MongoDB collection '{MONGO_COLLECTION}' in database '{MONGO_DB}'")
...
if __name__ == "__main__":
    ...
    save_logs_to_mongodb(num_logs=10)
